      ...
      <main className="page">
        <div className="hero">
          ...
          <p className="subtitle">
            An AI avatar hosts trivia using backend RPC to fetch questions
...
function TriviaGame(props: {
  ...
  const handleShowQuestion = useCallback((args: { question: string; options: Array<string>; questionNumber: number }) => {
    setQuestion(args);
    setResult(null);
  }, []);
